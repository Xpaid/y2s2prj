...
public class EmployeeViewer extends RoundedPanel implements Functions {
	...
	protected static JTextField txtF_EmployeeFirstName;
	protected static JTextField txtF_EmployeeLastName;

	protected static JTextField txtF_EmployeeAge;
	protected static JTextField txtF_EmployeeId;

	protected static JTextField txtF_EmployeeAddress;
	protected static JTextField txtF_EmployeeBirthDate;
	protected static JTextField txtF_EmployeeGender;

	protected static JTextField txtF_EmployeeEmail;
	protected static JTextField txtf_EmployeeContact;

	protected static JTextField txtF_EmployeeJobTitle;
	protected static JTextField txtF_EmployeeStartDate;
	protected static JTextField txtf_EmployeeWorkLocation;

	protected static JTextField txtF_EmployeeBankAcc;
	protected static JTextField txtF_EmployeeContractEnd;
	protected static JTextField txtF_EmployeeMonthlySalary;
	protected static JTextField txtF_EmployeeHourlyWage;
	...
	private void setBirth() {
		...
		txtF_EmployeeBirthDate = new JTextField();
		txtF_EmployeeBirthDate.setBorder(null);
		txtF_EmployeeBirthDate.setEditable(false);
		txtF_EmployeeBirthDate.setHorizontalAlignment(SwingConstants.CENTER);
		txtF_EmployeeBirthDate.setFont(new Font("Consolas", Font.PLAIN, 14));
		txtF_EmployeeBirthDate.setForeground(DarkModeColorPalette.LIGHT_GRAY);
		txtF_EmployeeBirthDate.setBackground(DarkModeColorPalette.SLIGHTLY_LIGHTER_CHARCOAL);
		txtF_EmployeeBirthDate.setBounds(451, 272, 95, 20);
		container.add(txtF_EmployeeBirthDate);
	}
	...
	private void setStartedDate() {
		...
		lblStarted.setBounds(275, 425, 56, 14);
		...
		txtF_EmployeeStartDate = new JTextField();
		txtF_EmployeeStartDate.setBorder(null);
		txtF_EmployeeStartDate.setEditable(false);
		txtF_EmployeeStartDate.setHorizontalAlignment(SwingConstants.CENTER);
		txtF_EmployeeStartDate.setFont(new Font("Consolas", Font.BOLD, 13));
		txtF_EmployeeStartDate.setForeground(DarkModeColorPalette.LIGHT_GRAY);
		txtF_EmployeeStartDate.setBackground(DarkModeColorPalette.SLIGHTLY_LIGHTER_CHARCOAL);
		txtF_EmployeeStartDate.setBounds(340, 422, 57, 20);
		container.add(txtF_EmployeeStartDate);

	}

	private void setContractEnd() {
		JLabel lblEndOfContract = new JLabel("Contract End:");
		lblEndOfContract.setBounds(405, 425, 91, 14);
		...
		txtF_EmployeeContractEnd = new JTextField();
		txtF_EmployeeContractEnd.setBorder(null);
		txtF_EmployeeContractEnd.setEditable(false);
		txtF_EmployeeContractEnd.setHorizontalAlignment(SwingConstants.CENTER);
		txtF_EmployeeContractEnd.setFont(new Font("Consolas", Font.BOLD, 13));
		txtF_EmployeeContractEnd.setForeground(DarkModeColorPalette.LIGHT_GRAY);
		txtF_EmployeeContractEnd.setBackground(DarkModeColorPalette.SLIGHTLY_LIGHTER_CHARCOAL);
		txtF_EmployeeContractEnd.setBounds(501, 422, 57, 20);
		container.add(txtF_EmployeeContractEnd);

	}

	private void setMonthlySalary() {
		JLabel lblSallary = new JLabel("Monthly Salary:");
		lblSallary.setBounds(275, 475, 105, 14);
	...
	private void setHourlyWage() {
		...
		txtF_EmployeeHourlyWage.setBounds(125, 472, 140, 20);
