...
public class UserPanel extends RoundedPanel {
	...
	public static JTextField txtF_CompanyName;
	public static JTextField txtF_ClientName;
	public static JTextField txtF_ClientRole;
	public static JTextField txtF_ClientId;
	public static JTextField txtF_ClientStatus;
	...
	private void setClientNameField() {
		txtF_ClientName = new JTextField("Admin");
	...
	private void setClientIdField() {
		txtF_ClientId = new JTextField("#01");
